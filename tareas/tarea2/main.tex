...
%\fontsize{10}{10}
\maketitle
\note{Esta tarea es individual y se debe entregar en el buzón habilitado para eso en Canvas (2 semanas de plazo). Para el desarrollo de los problemas, escriba el desarrollo en el mayor detalle posible, y defina todos los objetos matemáticos que use.

La tarea tiene 18 puntos, pero el puntaje máximo será de 10 puntos. En cada pregunta, el puntaje dado será: el total si está bien, la mitad si tiene un desarrollo concluyente pero tiene errores, y 0.0 puntos si tiene poco o nada de desarrollo. Las tareas atrasadas tendrán un descuento lineal tal que en 48 hrs la nota máxima sea un 1.0.}
