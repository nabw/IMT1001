...
En la tarea se presentan diez problemas, y el puntaje máximo será de 7 puntos. En cada pregunta, el puntaje dado será: el total si está bien, la mitad si tiene un desarrollo concluyente pero tiene errores, y 0.0 puntos si tiene poco o nada de desarrollo.}
