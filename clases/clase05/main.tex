...
\begin{frame}{Operaciones}
    ...
    \end{itemize}
    \pause
    \idea{Demostrar transitividad: Si $A\subseteq B$ y $B\subseteq C$, luego $A\subseteq C$.} 
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Operaciones II}
    \begin{small}
    \begin{itemize}
        \item Intersección:  $ A \cap B = \{ x | x\in A \wedge x\in B\} $ \hfill \textcolor{gray}{(Si $A\cap B = \emptyset$ son \emph{disjuntos})}
