...
\begin{frame}{Independencia lineal}
    ...
    \end{itemize}
    \idea{Interpretar identidad $\cos 2\theta = 2\cos^2\theta-1$ como dependencia lineal}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Espacios de Hilbert}
    \begin{block}{Espacio de Hilbert\foonote{Definición incompleta}}
    ...
    \end{block}
    \idea{Verificar que producto interno de vectores cumple estas propiedades}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
